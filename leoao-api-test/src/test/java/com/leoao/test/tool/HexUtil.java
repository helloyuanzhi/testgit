...
public class HexUtil {
    ...
    private final static Locale locale  = Locale.CHINESE;
    ...
    public static boolean checkHexStr(String sHex) {
        String sTmp = sHex.toString().trim().replace(" ", "").toUpperCase(locale);
    ...
    public static String hexStr2Str(String hexStr) {
        hexStr = hexStr.toString().trim().replace(" ", "").toUpperCase(locale);
    ...
    public static String byte2HexStr(byte[] b) {
        ...
        return sb.toString().trim().toLowerCase(locale);
    }
     ...
     * @return String 每个Byte值之间空格分隔
     */
    public static String byte2HexStr(byte[] b, boolean needSeparator) {
        if (b == null) {
            return null;
        }
        return byte2HexStr(b, b.length, needSeparator);
    }
     ...
     * @return String 每个Byte值之间空格分隔
     */
    public static String byte2HexStr(byte[] b, int iLen, boolean needSeparator) {
        if (b == null) {
            return null;
        }
        StringBuilder sb = new StringBuilder();
    ...
    public static byte[] hexStr2Bytes(String src) {
        /* 对输入值进行规范化整理 */
        src = src.trim().replace(" ", "").toUpperCase(locale);
        // 处理值初始化
        int m = 0, n = 0;
